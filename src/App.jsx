    ...
    return (
        <div className='w-full h-screen  bg-white flex justify-center align-middle'>
            <div className='w-400 h-100 grid grid-cols-1 text-6xl '>
                ...
                <div className=' flex justify-center items-center '><span className='tracking-tight font-medium text-purple-600'>{users} Reflectans have signed up and started using the app.</span></div>
